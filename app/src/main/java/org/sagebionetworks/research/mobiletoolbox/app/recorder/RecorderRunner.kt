...
class RecorderRunner(
    ...
    private val recorders: List<Recorder<out Result>>
    ...
    internal fun recorderFactory(recorderScheduledAssessmentConfig: RecorderScheduledAssessmentConfig): Recorder<out Result>? {
